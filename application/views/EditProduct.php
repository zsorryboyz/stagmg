...
<body>
  ...
  <a class="navbar-brand" href="<?php echo base_url('Main/home'); ?>">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('Main/Messenger'); ?>">สนทนา</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('Main/order'); ?>">รายการสั่งสินค้า</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">สถิติ</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="<?php echo base_url('Main/product'); ?>">จัดการร้านค้า</a>
        </li>
      </ul>
    </div>
</nav>
  ...
  <div class="d-flex" id="wrapper" style="margin-left: 20px;">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      <div class="list-group list-group-flush">
        ...
        <a href="<?php echo base_url('Main/Product'); ?>" class="list-group-item list-group-item-action bg-light">อัลบัมสินค้า</a>
        <a href="<?php echo base_url('Main/orderstore'); ?>" class="list-group-item list-group-item-action bg-light">สินค้าคงคลัง</a>
            ...
            <div class="col-lg-12"><!-- col-lg-12 Begin -->
                ...
                <ol class="breadcrumb"><!-- breadcrumb Begin -->
                    ...
                    <li class="active"><!-- active Begin -->
                        ...
                        <i class="fa fa-dashboard"></i>/ Edit Products
                       ...
                       <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                           ...
                           <div class="form-group"><!-- form-group Begin -->
                              ...
                              <div class="col-md-6"><!-- col-md-6 Begin -->
                                  ...
                                  <input value="<?php  echo $name_product ?>" name="product_title" type="text" name="text_key" onkeyup="validate();"
                           ...
                           <div class="form-group"><!-- form-group Begin -->
                              ...
                              <div class="col-md-6"><!-- col-md-6 Begin -->
                                  <input id="protype" value="<?php echo $product_type?>" hidden>
                                 ...
                                 <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <div class="col-md-6"><!-- col-md-6 Begin -->
                                        ...
                                        <input value="<?php  echo $Product_Image?>" id="product_img1" type="file" class="form-control" required>
                                 ...
                                 <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <div class="col-md-6"><!-- col-md-6 Begin -->
                                        ...
                                        <input value="<?php  echo $product_price?>" id="product_price" type="text" name="text_plain" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/
                                 ...
                                 <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <div class="col-md-6"><!-- col-md-6 Begin -->
                                        ...
                                        <input value="<?php  echo $product_amount?>" id="product_Amount" type="text " name="text_plain" onKeyUp="if(isNaN(this.value)){ alert('กรุณากรอกตัวเลข'); this.value='';}"/
                                        class="form-control" required>
                                 ...
                                 <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <div class="col-md-6"><!-- col-md-6 Begin -->
                                        ...
                                        <textarea  id="product_desc" cols="19" rows="6" class="form-control"><?php  echo $product_desc?> </textarea>
                                 ...
                                 <div class="form-group"><!-- form-group Begin -->
                                    ...
                                    <div class="col-md-6"><!-- col-md-6 Begin -->
                                        ...
                                        <input name="submit" value="Edit Product" id="button_Edit" type="button" class="btn btn-primary form-control">
  ...
  $(document).ready(function(){
    ...
    $("#button_Edit").click(function(){
      ...
      formData.append('idProduct', $('#id').val());
